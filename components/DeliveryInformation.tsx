  ...
  return (
    ...
    <StyledView className="bg-white h-full rounded-xl p-5" >
      ...
      <StyledView className="flex-row items-center justify-between gap-5 mb-4">
        <StyledText className="text-xl text-center font-bold text-black">Delivery Information</StyledText>
        <TouchableOpacity onPress={onClose}>
          <StyledText className="text-base font-bold text-red-500">Close</StyledText>
        </TouchableOpacity>
      </StyledView>

      {/* Order ID */}
      <StyledView className="flex-row justify-between items-center mb-6">
        <StyledText className="text-base font-bold text-gray-700">Order ID</StyledText>
        <StyledText className="text-base font-bold text-gray-700">MZZ4-VVY2</StyledText>
      </StyledView>
      ...
      <StyledView className="flex-row items-center mb-6">
        ...
        <StyledView className="ml-4">
          <StyledText className="text-sm font-bold text-gray-800">16 Jul</StyledText>
          <StyledText className="text-sm text-gray-500">20:53</StyledText>
          <StyledView className="bg-gray-100 p-3 rounded-md mt-2">
            <StyledText className="text-sm font-bold text-black">Order delivered</StyledText>
          </StyledView>
        </StyledView>
      </StyledView>
      ...
      <StyledView className="flex-row items-center mb-6">
        ...
        <StyledView className="ml-4">
          ...
          <StyledView className="bg-gray-100 p-3 rounded-md mt-2">
            <StyledText className="text-sm font-bold text-black">Order out for delivery</StyledText>
          </StyledView>
        </StyledView>
      </StyledView>
      ...
      <StyledView className="flex-row items-center mb-6">
        ...
        <StyledView className="ml-4">
          ...
          <StyledView className="bg-gray-100 p-3 rounded-md mt-2">
            <StyledText className="text-sm font-bold text-black">Order received</StyledText>
          </StyledView>
        </StyledView>
      </StyledView>
    </StyledView>
