    ...
    <StyledScrollView className='bg-gray-200 px-4 py-2'>
      <StyledView className='flex-row justify-between gap-2 items-center'>
        <StyledTextInput
          ...
          className='text-gray-700 w-[75%] border-gray-300 border p-3 rounded-xl text-lg'
        ...
        <StyledTouchableOpacity className='relative flex flex-row '>
          ...
          <Link href={ROUTES.CUSTOMER.PAGES.HOME.CART}>
      ...
      <StyledView className='px-4 py-2 relative mt-1'>
        <StyledImage
          source={b1}
          className='w-full h-36 max-[390px]:h-32 rounded-lg'
        />
