      ...
      <StyledScrollView>
        ...
        <StyledView className='flex-row justify-between items-center px-4 py-2 bg-white'>
          <StyledView className='flex-row items-center gap-1'>
            <StyledText className='text-xl font-semibold text-black'>
              MkMed
            </StyledText>
          </StyledView>
        ...
        {/* Banner Section 1 */}
        <StyledView
          className='mx-4 bg-lightPurple p-4 mb-4'
          style={{ borderRadius: 20 }}
        >
          <StyledText className='text-base font-extrabold text-black'>
            UPLOAD PRESCRIPTION
          </StyledText>
          ...
          <StyledView className='flex flex-row justify-between'>
            ...
            <StyledTouchableOpacity className='bg-darkPurple rounded-lg px-4 py-2 mt-4'>
              <Link href={'tabs/upload'} className='text-white text-center'>
                ORDER NOW
              </Link>
            </StyledTouchableOpacity>
          </StyledView>
